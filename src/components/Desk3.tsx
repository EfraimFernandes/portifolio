                        ...
                        {isShown && (
                            <div className={styles.descSquare}>
                                ...
                                <div className={styles.desc}>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam mollitia, quod blanditiis et culpa voluptate dolor a beatae odit corrupti, quae voluptatibus labore rerum nemo laudantium vel recusandae, sapiente nulla.</p>
                                </div>
                            </div>
                        )}
                    </div>
